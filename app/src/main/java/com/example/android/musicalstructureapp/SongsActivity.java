...
public class SongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create a list of songs, which include song title, artist, album (if song has it), album
        //artwork (if song has it)
        ArrayList<Song> songs = new ArrayList<Song>();
        songs.add(new Song("Addicted", "Simple Plan",
                "No pads, no helmets...just balls",
                R.drawable.album_artwork_simple_plan_no_pads_no_helmets_just_balls));
        songs.add(new Song("My Alien", "Simple Plan"));
        songs.add(new Song("Zoe Jane", "Staind", "14 shades of grey",
                R.drawable.album_artwork_staind_14_shades_of_grey));
        songs.add(new Song("So Far Away", "Staind", "14 shades of grey",
                R.drawable.album_artwork_staind_14_shades_of_grey));
        songs.add(new Song("All I Want", "Staind", "The illusion of progress",
                R.drawable.album_artwork_staind_the_illusion_of_progress));
        ...
        // SetOnClickListener to Image with ID songs_back_image_view, in activity_songs.xml,
